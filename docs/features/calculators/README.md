# Calculator Suite — authority map

This folder is the current product-definition home for FinTutor's nine approved production Calculators.

Authority order:

1. `PROJECT_SPEC.md` and product principles;
...
Tax/HRA, XIRR, rent-versus-buy and any additional catalogue remain outside this workstream.
