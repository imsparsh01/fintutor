...
| D-166 | READY → BQ-140 | Four remaining D-148 workstreams in recommended order; Scenario/focused explorers next | ESOP reconciliation shipped; authoritative aggregate candidate provenance is next |
...
| D-170 | READY → BQ-140 | Approved Scenario safety, eligibility, provenance and release package | O-SC-9A/B and O-SC-10 shipped; O-SC-9C aggregate provenance is next |
...
| D-172 | READY → BQ-140 | Scenario and focused-explorer package receives owner PASS | BQ-139 ESOP reconciliation shipped; continue with aggregate candidate provenance |
