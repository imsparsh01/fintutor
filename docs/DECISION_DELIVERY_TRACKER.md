...
| D-173 | READY → BQ-151 | Calculator suite is the next complete workstream | Production plan complete; exact older-engine/domain reconciliation is next |
...
| D-175 | READY → BQ-151 | Calculator package receives owner PASS | BQ-150 maps production gaps into BQ-151..BQ-154; exact engine/domain work is next |
