...
| D-166 | READY → BQ-136 | Four remaining D-148 workstreams in recommended order; Scenario/focused explorers next | Production audit complete; EX-80C containment is the first reconciliation build |
...
| D-170 | READY → BQ-136 | Approved Scenario safety, eligibility, provenance and release package | Reconciliation plan BQ-136..BQ-144 defined; internal-only 80C containment is first |
...
| D-172 | READY → BQ-136 | Scenario and focused-explorer package receives owner PASS | Production reconciliation mapped in BQ-135; execute BQ-136 first |
