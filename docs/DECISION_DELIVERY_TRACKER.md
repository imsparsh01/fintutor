...
| D-148 | BLOCKED → BQ-109 | Baseline package/prototype complete; D-149 resolves three forks and selects live goal value | Owner approves the goal cap/allocation/unknown rule, then validates eight tasks |
| D-149 | BLOCKED → BQ-109 | Supporting-object lifecycle, stale-write and reminder recovery contracts approved; live goal-value direction selected | Goal-progress money rule and D-148 owner validation remain |
