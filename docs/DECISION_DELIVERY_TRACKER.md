...
| D-173 | READY → BQ-150 | Calculator suite is the next complete workstream | Owner PASS recorded; production reconciliation planning is next |
...
| D-175 | READY → BQ-150 | Calculator package receives owner PASS | Frozen package at `4f83dfb`; production reconciliation plan is next |
