...
| D-158 | READY → BQ-121 | Onboarding and first-action handoff definition deep dive; BQ-120 complete, BQ-121..BQ-124 approved | Contracts are next; prototype and owner validation follow without production mutation |
