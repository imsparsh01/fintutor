...
| D-173 | READY → BQ-147 | Calculator suite is the next complete workstream | BQ-145/BQ-146 reconciled the suite and contracts; acceptance evidence and owner decision routing are next |
