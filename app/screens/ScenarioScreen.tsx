...
type FrozenResult = { title: string; primary: string; rows?: { label: string; value: string }[]; summary: string[]; formula: string; limits: string; handoffPrompt: string };
