...
//
// BQ-141 (D-167/D-168): the five dedicated Scenarios sit below the calculators and navigate
// to ScenarioScreen. Contextual focused explorers stay on their relevant record surfaces.
...
export function ToolsScreen() {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <Text style={[styles.sectionLabel, styles.sectionLabelSpaced]}>Scenarios</Text>
      <Text style={styles.sectionNote}>
        Explore consequences using assumptions you choose. Recorded figures are offered as
        source-labelled candidates and stay excluded until you include them.
      </Text>
      <View style={styles.card}>
        {SCENARIOS.map((s, idx) => (
          <Pressable
